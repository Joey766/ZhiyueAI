...
{"overall_score":整数,"summary":"","dimensions":[{"name":"","score":整数,"reason":""}],"strengths":[{"name":"","evidence":"档案中的原文技能、项目或经历"}],"gaps":[{"name":"","priority":"高|中|低","reason":"","current_evidence":"当前档案中尚未看到…（不得断言用户不会）","actions":["","",""],"estimated_effort":""}],"skill_gap":[{"name":"","category":"Must-have|Nice-to-have|Missing / unclear","evidence":""}],"jd_keywords":[""],"resume_evidence":[""],"application_advice":["","",""],"apply_recommendation":{"decision":"建议申请|可以尝试|建议先补强核心能力","reason":""}}
